...
public class LuckyCoinItems {
	...
	static {
		LUCKY_COPPER_CAT_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_cat_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_PLAINS_HOUSE,BuiltInLootTables.VILLAGE_DESERT_HOUSE,BuiltInLootTables.VILLAGE_SAVANNA_HOUSE,BuiltInLootTables.VILLAGE_SNOWY_HOUSE,BuiltInLootTables.VILLAGE_TAIGA_HOUSE,BuiltInLootTables.FISHING_TREASURE), Set.of(EntityType.CAT), List.of(StewEffects.SPEED) );
		LUCKY_COPPER_CHICKEN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_chicken_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_FLETCHER), Set.of(EntityType.CHICKEN), List.of(StewEffects.SLOW_FALLING) );
		LUCKY_COPPER_SHEEP_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_sheep_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_SHEPHERD), Set.of(EntityType.SHEEP), List.of(StewEffects.ABSORPTION) );
		LUCKY_COPPER_IRON_GOLEM_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_iron_golem_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_ARMORER,BuiltInLootTables.PILLAGER_OUTPOST), Set.of(EntityType.IRON_GOLEM), List.of(StewEffects.RESISTANCE) );
		LUCKY_COPPER_WOLF_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_wolf_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_RARE), Set.of(EntityType.WOLF), List.of(StewEffects.STRENGTH,StewEffects.SPEED) );
		LUCKY_COPPER_ZOMBIE_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_zombie_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.ANCIENT_CITY), Set.of(EntityType.ZOMBIE), List.of(StewEffects.NIGHT_VISION) );
		LUCKY_COPPER_DOLPHIN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_dolphin_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.UNDERWATER_RUIN_BIG,BuiltInLootTables.FISHING_TREASURE), Set.of(EntityType.DOLPHIN), List.of(StewEffects.DOLPHINS_GRACE) );
		LUCKY_COPPER_HEART_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_copper_heart_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.CLERIC_GIFT,BuiltInLootTables.FARMER_GIFT), Set.of(EntityType.PLAYER), List.of(StewEffects.REGENERATION) );
		
		LUCKY_IRON_CAT_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_iron_cat_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_PLAINS_HOUSE,BuiltInLootTables.VILLAGE_DESERT_HOUSE,BuiltInLootTables.VILLAGE_SAVANNA_HOUSE,BuiltInLootTables.VILLAGE_SNOWY_HOUSE,BuiltInLootTables.VILLAGE_TAIGA_HOUSE,BuiltInLootTables.FISHING_TREASURE), Set.of(EntityType.CAT), List.of(StewEffects.SPEED,StewEffects.NIGHT_VISION) );
		LUCKY_IRON_CHICKEN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_iron_chicken_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_FLETCHER), Set.of(EntityType.CHICKEN), List.of(StewEffects.SLOW_FALLING) );
		LUCKY_IRON_GOLEM_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_iron_golem_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_ARMORER,BuiltInLootTables.PILLAGER_OUTPOST), Set.of(EntityType.IRON_GOLEM), List.of(StewEffects.RESISTANCE,StewEffects.STRENGTH) );
		LUCKY_IRON_SHEEP_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_iron_sheep_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_SHEPHERD), Set.of(EntityType.SHEEP), List.of(StewEffects.ABSORPTION,StewEffects.SPEED) );
		LUCKY_IRON_VEX_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_iron_vex_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.WOODLAND_MANSION), Set.of(EntityType.VEX), List.of(StewEffects.LEVITATION) );
		
		LUCKY_GOLD_BLAZE_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_gold_blaze_coin", CollectableCoinFeature.GOLD_VALUE, CoinFeature.GOLD_RARITY, CollectableCoinFeature.GOLD_DROP_CHANCE, 1, 1, 1, CoinFeature.GOLD_FLIP_CHANCE, CollectableCoinFeature.GOLD_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.NETHER_BRIDGE), Set.of(EntityType.BLAZE), List.of(StewEffects.FIRE_RESISTANCE,StewEffects.STRENGTH,StewEffects.SLOW_FALLING) );
		LUCKY_GOLD_PIGLIN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "lucky_gold_piglin_coin", CollectableCoinFeature.GOLD_VALUE, CoinFeature.GOLD_RARITY, CollectableCoinFeature.GOLD_DROP_CHANCE, 1, 1, 1, CoinFeature.GOLD_FLIP_CHANCE, CollectableCoinFeature.GOLD_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.BASTION_TREASURE), Set.of(EntityType.PIGLIN,EntityType.PIGLIN_BRUTE), List.of(StewEffects.STRENGTH,StewEffects.FIRE_RESISTANCE,StewEffects.RESISTANCE) );
