...
public class LuckyCoinItems {
	...
	static {
		LUCKY_COPPER_CAT_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_cat_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_PLAINS_CHEST,LootTables.VILLAGE_DESERT_HOUSE_CHEST,LootTables.VILLAGE_SAVANNA_HOUSE_CHEST,LootTables.VILLAGE_SNOWY_HOUSE_CHEST,LootTables.VILLAGE_TAIGA_HOUSE_CHEST,LootTables.FISHING_TREASURE_GAMEPLAY), Set.of(EntityType.CAT), List.of(StewEffects.SPEED) );
		LUCKY_COPPER_CHICKEN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_chicken_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_FLETCHER_CHEST), Set.of(EntityType.CHICKEN), List.of(StewEffects.SLOW_FALLING) );
		LUCKY_COPPER_SHEEP_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_sheep_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_SHEPARD_CHEST), Set.of(EntityType.SHEEP), List.of(StewEffects.ABSORPTION) );
		LUCKY_COPPER_IRON_GOLEM_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_iron_golem_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_ARMORER_CHEST,LootTables.PILLAGER_OUTPOST_CHEST), Set.of(EntityType.IRON_GOLEM), List.of(StewEffects.RESISTANCE) );
		LUCKY_COPPER_WOLF_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_wolf_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.TRIAL_CHAMBERS_REWARD_RARE_CHEST), Set.of(EntityType.WOLF), List.of(StewEffects.STRENGTH,StewEffects.SPEED) );
		LUCKY_COPPER_ZOMBIE_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_zombie_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.ANCIENT_CITY_CHEST), Set.of(EntityType.ZOMBIE), List.of(StewEffects.NIGHT_VISION) );
		LUCKY_COPPER_DOLPHIN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_dolphin_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.UNDERWATER_RUIN_BIG_CHEST,LootTables.FISHING_TREASURE_GAMEPLAY), Set.of(EntityType.DOLPHIN), List.of(StewEffects.DOLPHINS_GRACE) );
		LUCKY_COPPER_HEART_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_copper_heart_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.HERO_OF_THE_VILLAGE_CLERIC_GIFT_GAMEPLAY,LootTables.HERO_OF_THE_VILLAGE_FARMER_GIFT_GAMEPLAY), Set.of(EntityType.PLAYER), List.of(StewEffects.REGENERATION) );
		
		LUCKY_IRON_CAT_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_iron_cat_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_PLAINS_CHEST,LootTables.VILLAGE_DESERT_HOUSE_CHEST,LootTables.VILLAGE_SAVANNA_HOUSE_CHEST,LootTables.VILLAGE_SNOWY_HOUSE_CHEST,LootTables.VILLAGE_TAIGA_HOUSE_CHEST,LootTables.FISHING_TREASURE_GAMEPLAY), Set.of(EntityType.CAT), List.of(StewEffects.SPEED,StewEffects.NIGHT_VISION) );
		LUCKY_IRON_CHICKEN_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_iron_chicken_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_FLETCHER_CHEST), Set.of(EntityType.CHICKEN), List.of(StewEffects.SLOW_FALLING) );
		...
		LUCKY_IRON_SHEEP_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( "lucky_iron_sheep_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_SHEPARD_CHEST), Set.of(EntityType.SHEEP), List.of(StewEffects.ABSORPTION,StewEffects.SPEED) );
